"""
Django settings for logistica_SV project.
"""
...
ROOT_URLCONF = 'logistica_SV.urls'
...
WSGI_APPLICATION = 'logistica_SV.wsgi.application'
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        'NAME': os.getenv('DB_NAME', 'logistica_SV_db'),
        'USER': os.getenv('DB_USER', 'django_user'),
        'PASSWORD': os.getenv('DB_PASSWORD'),
        'HOST': os.getenv('DB_HOST', 'LRCANDRAY\\SQLEXPRESS'),
        'OPTIONS': {
